...
function ComplianceEditor({ row, onClose, onSave, saving, error, initialUploadType = 'license', initialTab = 'details' }) {
  ...
  const removeAnnualReportCompletion = async () => {
    ...
    try {
      ...
      setCompletionMessage(err.response?.data?.detail || 'Unable to remove annual report completion.')
    } finally {
